package edu.wpi.cs3733.c22.teamD.database.login;
 ...
 *
 * <p>Instances of this class can be used concurrently by multiple threads.
 *
 * @author erickson
...
public final class PBKDF2Hasher {
   ...
   *
   * <p>Passwords should be stored in a {@code char[]} so that it can be filled with zeros after use
   * instead of lingering on the heap and elsewhere.
   *
